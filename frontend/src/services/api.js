...
export const getOrderTimeline = (orderId) => api.get(`/orders/${orderId}/timeline`)
export const addOrderTimeline = (orderId, data) => api.post(`/orders/${orderId}/timeline`, data)
export const getOrderTasks = (orderId) => api.get(`/orders/${orderId}/tasks`)
export const addOrderTask = (orderId, title) => api.post(`/orders/${orderId}/tasks`, { title })
export const updateOrderTask = (orderId, taskId, data) => api.patch(`/orders/${orderId}/tasks/${taskId}`, data)
export const deleteOrderTask = (orderId, taskId) => api.delete(`/orders/${orderId}/tasks/${taskId}`)
