...
export const getTicketAssignedCounts = () => api.get('/tickets/assigned-counts')
...
export const getDispatchAssignedCounts = () => api.get('/despachos/assigned-counts')
export const dispatchStockCheck = (items) => api.post('/despachos/stock-check', { items })
export const getOversoldReport = () => api.get('/inventory/oversold')
...
// ── Órdenes de recibo de inventario ──
export const getReceiptNextNumber = () => api.get('/inventory/receipts/next-number')
export const getReceipts = (params) => api.get('/inventory/receipts', { params })
export const getReceipt = (id) => api.get(`/inventory/receipts/${id}`)
export const createReceipt = (data) => api.post('/inventory/receipts', data)
export const updateReceipt = (id, data) => api.put(`/inventory/receipts/${id}`, data)
export const finalizeReceipt = (id, data) => api.post(`/inventory/receipts/${id}/finalize`, data)
export const deleteReceipt = (id) => api.delete(`/inventory/receipts/${id}`)
export const getReceiptPdf = (id) => api.get(`/inventory/receipts/${id}/pdf`, { responseType: 'blob' })
export const sendReceiptEmail = (id, email) => api.post(`/inventory/receipts/${id}/send-email`, { email })
export const reviewReceiptItems = (id, items) => api.patch(`/inventory/receipts/${id}/review`, { items })
export const getReceiptsPendingReview = () => api.get('/inventory/receipts/pending-review')
// ── Devoluciones a proveedor ──
export const getReturnNextNumber = () => api.get('/inventory/returns/next-number')
export const getReturns = (receiptId) => api.get('/inventory/returns', { params: receiptId ? { receipt_id: receiptId } : {} })
export const getReturn = (id) => api.get(`/inventory/returns/${id}`)
export const createReturn = (data) => api.post('/inventory/returns', data)
export const updateReturn = (id, data) => api.put(`/inventory/returns/${id}`, data)
export const getReturnPdf = (id) => api.get(`/inventory/returns/${id}/pdf`, { responseType: 'blob' })
export const sendReturnEmail = (id, email) => api.post(`/inventory/returns/${id}/send-email`, { email })
