...
const navItems = [
  ...
  { to: '/inventario',        group: 'comercial', subgroup: 'maestros', featureKey: 'inventario',          moduleKey: 'inventario',          label: 'Inventario',            icon: Package,         roles: ['admin', 'supervisor', 'agent', 'ventas', 'supplies', 'superadmin'],  color: 'text-emerald-500', bg: 'bg-emerald-500/15' },
  { to: '/partes',            group: 'comercial', subgroup: 'maestros', featureKey: null,                  moduleKey: 'inventario',          label: 'Solicitudes de Partes', icon: Boxes,           roles: ['admin', 'supervisor', 'supplies', 'superadmin'],         color: 'text-teal-500',    bg: 'bg-teal-500/15' },
