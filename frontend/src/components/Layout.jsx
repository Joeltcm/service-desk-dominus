...
const navItems = [
  ...
  { to: '/mis-documentos',    group: 'main',      subgroup: null,       featureKey: null,                  moduleKey: null,                  label: 'Mis Documentos',        icon: FileText,        roles: ['client'],                    color: 'text-indigo-500',  bg: 'bg-indigo-500/15' },
